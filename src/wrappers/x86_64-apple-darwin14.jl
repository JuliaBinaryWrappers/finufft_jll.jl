# Autogenerated wrapper script for finufft_jll for x86_64-apple-darwin14
export libfinufft
...
const libfinufft_splitpath = ["lib", "libfinufft.dylib"]
...
const libfinufft = "@rpath/libfinufft.so"
