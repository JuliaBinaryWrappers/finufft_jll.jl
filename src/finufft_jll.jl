...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import finufft_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("c41cd5a2-72a3-5203-9076-a500b088fc82"))
platforms = [Pkg.Artifacts.unpack_platform(e, "finufft", artifacts_toml) for e in artifacts["finufft"]]
...
if best_platform === nothing
    @debug("Unable to load finufft; unsupported platform $(triplet(platform_key_abi()))")
else
